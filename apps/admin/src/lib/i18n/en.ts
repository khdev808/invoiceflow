...
export const en = {
  ...
  reason3Body: 'Time tracking, expenses, mileage, credit notes, and P&L reports — no per-feature upsells.',
  reason4Title: 'Get paid faster',
  reason4Body: 'Stripe, PayPal, client portal payments, deposit requests, and automated reminders.',
  ...
  reason6Body: 'Full web app for desktop work. Native iOS & Android apps for invoicing on the go.',
  reason7Title: 'Real cloud sync',
  reason7Body: 'PostgreSQL-backed sync across devices. Your data is always available when you are online.',
