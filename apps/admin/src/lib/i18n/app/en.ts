export const appEn = {
  ...
  opened: 'Opened',
  clientViewedPortal: 'Client viewed portal',
  ...
  sending: 'Sending…',
  addClientEmailFirst: 'Add an email to this client before sending.',
  ...
  smsDevOpened: 'SMS not configured — opened your phone’s SMS app with the message prefilled.',
  smsSent: 'SMS sent!',
  smsFailed: 'SMS failed',
  invoiceNotFound: 'Invoice not found',
  edit: 'Edit',
  phonePlaceholder: 'Client phone for SMS',
};
